# function for creatng a boxscore for batter stats from MLBAM's Game Day application using a game's boxscore.xml
...
test <- batter_boxscore("http://gd2.mlb.com/components/game/mlb/year_2016/month_05/day_21/gid_2016_05_21_milmlb_nynmlb_1/boxscore.xml")
