...
url <- "http://www.bergerrealty.com/rental/search.html?week=27&nweek=1&beds=7&bath=4&ulimit=0&minprice=3000&maxprice=3500&sortby=1&limit=100&year=2018"

geo <- read_html(url) %>%
  html_nodes(".geo") %>%
  html_text() %>%
  gsub(pattern = "July 07, 2018 to July 14, 2018", 
       replacement = "") %>%
  data_frame()
...
url2 <- "http://www.bergerrealty.com/rental/search.html?week=27&nweek=1&beds=7&bath=4&ulimit=0&minprice=3501&maxprice=4001&sortby=1&limit=100&year=2018"
...
url3 <- "http://www.bergerrealty.com/rental/search.html?week=27&nweek=1&beds=7&bath=4&ulimit=0&minprice=4001&maxprice=4401&sortby=1&limit=100&year=2018"
...
results_all <- results_all %>%
  mutate('link to listing' = paste0("<a href='", urls, "'>click to view</a>"))
